...
export const metadata: Metadata = {
  ...
  description: "Expert WordPress design & monthly maintenance in Dallas. Get a high-performing, SEO-ready website that grows your business. Plans from $325/mo. + setup.",
}
...
export default function WebsiteDesignPage() {
  ...
  const growthFeatures = [
    ...
    "Basic E-commerce Support (if applicable)",
  ...
  return (
    <main className="min-h-screen bg-white"> {/* Assuming a white base background */}
        ...
        <div className="container mx-auto px-6 text-center md:text-left">
          <div className="max-w-4xl mx-auto md:mx-0">
            ...
            <p className="text-lg max-w-2xl mx-auto md:mx-0 opacity-80 mb-10">
              In today's digital-first world, your website is your 24/7 salesperson and brand ambassador. Vixi Marketing Agency creates stunning, functional WordPress websites and provides continuous maintenance to ensure your Dallas business thrives online.
            </p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">Is Your Website Working For You?</h2>
            ...
            <p className="text-lg text-gray-600">
              Is your current website outdated, slow, or failing to convert visitors? Or are you a new business needing a powerful online launchpad? Vixi's comprehensive website design and monthly maintenance packages offer the perfect, hassle-free solution.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
              We believe a successful website is a journey, not a one-time project. That's why we combine expert WordPress design with proactive ongoing maintenance, all designed to deliver exceptional value and peace of mind.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              {/* Consider adding an illustrative image or graphic here related to web design/WordPress */}
              <img src="/placeholder-approach.jpg" alt="Modern website design process" className="rounded-lg shadow-md" />
            </div>
            <div className="space-y-6">
              {[
                ...
                { title: "A True Partnership", description: "Our monthly service model means we're your dedicated web partners, always on hand to keep your site fresh, secure, and performing optimally." }
              ].map((item) => (
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">
              Get a professional WordPress website without the large upfront cost. We start with a <strong className="text-primary-blue">one-time Initiation & Setup Fee of $500</strong>. Then, choose a monthly package with a 1-year minimum partnership.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-200 flex flex-col">
              ...
              <Button size="lg" className="w-full mt-auto bg-primary-blue hover:bg-secondary-blue text-white" asChild>
                <Link href="/contact?package=essentials">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl border-2 border-primary-blue flex flex-col relative"> {/* Highlighted package */}
              ...
              <div className="mb-6 pt-4">
                ...
                <p className="text-4xl font-bold text-gray-800">$575<span className="text-xl font-normal text-gray-500">/month</span></p>
                <p className="text-sm text-gray-500 mt-1">+ $500 Initiation & Setup Fee</p>
              </div>
              ...
              <Button size="lg" className="w-full mt-auto bg-primary-blue hover:bg-secondary-blue text-white" asChild>
                <Link href="/contact?package=growth">
      ...
      {/* Understanding "Minimum Changes" Section */}
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-800 mb-4 text-center">Understanding "Minimum Changes"</h3>
            <p className="text-lg text-gray-600 mb-6 text-center">
              To ensure clarity, our "Minimum Changes" included in your monthly package cover small updates that typically take up to 30 minutes per task. We allocate a set number of these tasks monthly for your convenience.
            </p>
            <div className="bg-white p-6 rounded-lg shadow-md border">
                ...
                <p className="text-gray-600 mt-4 text-sm">
                    For more substantial changes like adding entirely new sections, designing new pages beyond the initial 20, custom feature development, or extensive graphic design work, we’ll provide a separate, transparent quote.
                </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Need Something More? Custom Website Solutions</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            While our packages are designed for common business needs, we understand some Dallas projects require a uniquely tailored approach. If you're looking for advanced e-commerce, custom integrations, membership portals, or a website with significantly more than 20 pages, Vixi Marketing Agency has the expertise.
          </p>
          <Button size="lg" variant="outline" className="border-primary-blue text-primary-blue hover:bg-primary-blue hover:text-white" asChild>
            <Link href="/contact?service=custom-website">
      ...
      <section className="py-20 md:py-28 text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-10">
            Your website is too important to leave to chance. Partner with Vixi Marketing Agency and let our Dallas-based team of WordPress experts design a high-performing website and keep it running flawlessly with our comprehensive monthly maintenance plans.
          </p>
          <div className="space-x-0 space-y-4 sm:space-x-4 sm:space-y-0">
            ...
            <Button size="lg" variant="outline" className="border-primary-blue text-primary-blue hover:bg-primary-blue hover:text-white w-full sm:w-auto" asChild>
              <Link href="#pricing-packages"> {/* Link to the pricing section on the page */}
                View Our Packages Again
              </Link>
            </Button>
          </div>
        </div>
